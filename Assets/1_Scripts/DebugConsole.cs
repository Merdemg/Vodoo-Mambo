...
public class DebugConsole : MonoBehaviour
{
	...
	{
		// Feature: Display on-screen logs only if in Unity Editor
        // 2019.10.29 - LEVON
        //
		#if UNITY_EDITOR
		//
		...
		Trace.Msg("DebugConsole | " + color +" : " + message);
		#endif
	}
	//++++ OVERLOAD ++++
    [Conditional("USE_LOGS")]
	public static void Log(string message)
	{
		...
		Trace.Msg("DebugConsole | normal : " + message);
		#endif
	}
...
//					gui.GetComponent<Renderer> ().sortingOrder = 1;
